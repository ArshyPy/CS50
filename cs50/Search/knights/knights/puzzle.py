...
knowledge3 = And(
    ...
    # If B is a knight, A said 'I am a knave', and C is knave:
    Implication(BKnight, CKnave),
    Implication(BKnight, And(
        # A then said 'I am knave', A may be a Knight or a Knave:
        Implication(AKnight, AKnave),
        Implication(AKnave, Not(AKnave)),
    )),
    # If B is a knave, A said 'I am a Knight', A may be a Knight or a Knave:
